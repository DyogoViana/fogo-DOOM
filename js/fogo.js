...
const fireWidth = 40 // canvas.
const fireHeight = 40 // canvas.
...
function start () {
    ...
    setInterval (calculateFirePropagation, 50) // velocidade que carrega na tela.
}
    ...
    for (let row = 0; row < fireHeight; row++) { 
        ...
        for (let columm = 0; columm < fireWidth; columm++) {
            ...
            if (debug === true) {
                ...
                // html += fireIntensity // APAGAR DEPOIS
